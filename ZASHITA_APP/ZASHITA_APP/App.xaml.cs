...
using ZASHITA_APP.Services;
using ZASHITA_APP.ViewModels.Pages;
using ZASHITA_APP.ViewModels.Windows;
using ZASHITA_APP.Views.Pages;
using ZASHITA_APP.Views.Windows;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Wpf.Ui;
using ZASHITA_APP.ViewModels;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                // Add Quarantin and its view model
                services.AddSingleton<Quarantin>();
