...
namespace ZASHITA_APP.Dialogs
{
    public partial class FullScanDialog : FluentWindow
    {
        ...
        private async void StartScan(object sender, RoutedEventArgs e)
        {
            ...
            _selectedFiles.AddRange(GetFullScanFiles());
        ...
        private List<string> GetFullScanFiles()
        {
            ...
            try
            {
                if (Directory.Exists(rootDirectory))
                    files.AddRange(Directory.GetFiles(rootDirectory, "*.*", SearchOption.AllDirectories));
            }
            catch (Exception)
            {
            }
